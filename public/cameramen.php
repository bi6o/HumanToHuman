...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../includes/style-grey.css" />
</head>
            ...
            <a href="videoViewPage.php">
                <li class="col-md-3">
                    <div class="ch-item ch-img-1">
                        <div class="ch-info">
                            <h3>Mohamad Bitar</h3>
                            <p>Web Developer<a href="cameramenView.php"></a></p>
                        </div>
                    </div>
                </li>
            </a>
                <li class="col-md-3">
                    <div class="ch-item ch-img-2">
                        <div class="ch-info">
                            <h3>Maher Khedder</h3>
                            <p>Graphic Designer<a href="cameramenView.php">View it</a></p>
                        </div>
                    </div>
                </li>
